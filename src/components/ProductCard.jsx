...
const ProductCard = ({ data }) => {
    return (
        <Card className="group w-full p-3 sm:p-4 shadow-md hover:shadow-2xl transition duration-300 rounded-2xl ">
            ...
            <div className="mt-4 space-y-2">
                ...
                <Link
                    ...
                    className="block text-center mt-3 bg-gray-400 text-white py-2 text-sm sm:text-base rounded-xl hover:bg-gray-800 transition"
                >
                    View Details
                </Link>
